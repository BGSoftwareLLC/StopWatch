...
namespace BGStopwatch.Fonts
{
    /// <summary/>
    /// A helper class that provides named properties for all glyphs in Font Awesome 5 Brands Regular.
    /// <summary/>
    public class FontAwesome5BrandsRegular
    {
        public const string oopx = "\uf26e";
